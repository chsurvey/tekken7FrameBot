...
async def on_message(message):
    if message.author == client.user:
            ...
            if parameters[0] in character or parameters[0] == "Kuma" or parameters[0] == "Panda":
                ...
                if(parameters[1] in db_dic.keys()):
                    ...
                    for key in keys:
                        ...
                        # 큰 J
                        db_command = db_command.replace("\uff2a","")
        ...
        if cmd == '도움':
            ...
            embed.add_field(name="-약어추가 (커맨드 or 캐릭터 영어 명칭) (약어)", value="해당 영어 명칭을 약어로 대체합니다. ex)-약어추가 katarina 카타리나", inline=True)
